            ...
            if ("Pending".equals(post.getStatus())) {
                ...
                approveButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        groupNotification.send(db.loadUserByName(post.getUsername()).getUserId(), group.getGroupName(), "From group " + group.getGroupName() + ": admins accepted your post", "Gr");
                ...
                declineButton.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        groupNotification.send(db.loadUserByName(post.getUsername()).getUserId(), group.getGroupName(), "From group " + group.getGroupName() + ": admins declined your post", "Gr");
                        mainPanel.remove(postPanel);
                        mainPanel.revalidate();
                        mainPanel.repaint();
                        //parent.loadGroupPosts();                        
